...
inline static bool i0_ouput_addr_ui_try_sym(op_t& op, color_t color)
{
...
{
	if (i0_ouput_addr_ui_try_sym(op, COLOR_DREF))
	{
		return true;
	}
...
{
	if (i0_ouput_addr_ui_try_sym(op, COLOR_CREF))
	{
		return true;
	}
	return !OutValue(op, OOF_ADDR | OOFS_NOSIGN | OOFW_64);
}
